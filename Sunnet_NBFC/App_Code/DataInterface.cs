    ...
    public static DataTable GetLeadGeneration(clsLeadGenerationMaster cls)
    {
        ...
        using (DBOperation db = new DBOperation())
        {
            using (SqlCommand sqlCommand = new SqlCommand())
            {
                ...
                sqlCommand.Parameters.AddWithValue("@DSAId", "");
    ...
    public static DataTable GetLeadGenerationCustomer(clsLeadGenerationMaster cls)
    {
        ...
        using (DBOperation db = new DBOperation())
        {
            using (SqlCommand sqlCommand = new SqlCommand())
            {
                ...
                sqlCommand.Parameters.AddWithValue("@PresentStateId", Convert.ToInt32(cls.PresentStateId));
                sqlCommand.Parameters.AddWithValue("@PresentCityId", Convert.ToInt32(cls.PresentCityId));
                sqlCommand.Parameters.AddWithValue("@PermanentStateId", Convert.ToInt32(cls.PermanentStateId));
                sqlCommand.Parameters.AddWithValue("@PermanentCityId", Convert.ToInt32(cls.PermanentCityId));
                ...
                sqlCommand.Parameters.AddWithValue("@AAdharverfiy", Convert.ToInt32("1"));
                sqlCommand.Parameters.AddWithValue("@PanNo", cls.PanNo);
                sqlCommand.Parameters.AddWithValue("@PanVerify", Convert.ToInt32("1"));
    ...
    public static DataTable GetLeadGenerationCO_ApplicantCustomer(clsLeadGenerationMaster cls)
    {
        ...
        using (DBOperation db = new DBOperation())
        {
            using (SqlCommand sqlCommand = new SqlCommand())
            {
                ...
                sqlCommand.Parameters.AddWithValue("@PresentStateId", Convert.ToInt32(cls.CO_PresentStateId));
                sqlCommand.Parameters.AddWithValue("@PresentCityId", Convert.ToInt32(cls.CO_PresentCityId));
                sqlCommand.Parameters.AddWithValue("@PermanentStateId", Convert.ToInt32(cls.CO_PresentStateId));
                sqlCommand.Parameters.AddWithValue("@PermanentCityId", Convert.ToInt32(cls.CO_PermanentCityId));
    ...
    public static DataTable GetLeadGenerationGurantorCustomer(Gurantor cls)
    {
        ...
        using (DBOperation db = new DBOperation())
        {
            using (SqlCommand sqlCommand = new SqlCommand())
            {
                ...
                sqlCommand.Parameters.AddWithValue("@PresentStateId", Convert.ToInt32(cls.G_PresentStateId));
                sqlCommand.Parameters.AddWithValue("@PresentCityId", Convert.ToInt32(cls.G_PresentCityId));
                sqlCommand.Parameters.AddWithValue("@PermanentStateId", Convert.ToInt32(cls.G_P_State));
                sqlCommand.Parameters.AddWithValue("@PermanentCityId", Convert.ToInt32(cls.G_P_City));
                ...
                sqlCommand.Parameters.AddWithValue("@LeadID", cls.G_LeadNo);
