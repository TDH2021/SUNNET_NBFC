...
{
    public class LeadDocumentCollectionController : Controller
    {
        //// GET: LeadCalling
        ...
        //}
        // GET: LeadCalling
        public ActionResult LeadDocumentCollection(clsLeadDocSignMain M)
        {
            try
            {
                ...
                if (M.LeadId > 0)
                {
                    ...
                    dtLeadDoc = DataInterface1.dbLeadDocumentCollection(M);
                }
                if (dtLeadDetail != null && dtLeadDetail.Rows.Count > 0)
                    M = DataInterface.GetItem<clsLeadDocSignMain>(dtLeadDetail.Rows[0]);
        ...
        [HttpPost]
        public ActionResult LeadDocumentCollectionSave(clsLeadDocSignMain M)
        {
            ...
            try
            {
                ...
                dt = DataInterface1.dbLeadDocumentCollection(M);
            ...
            catch (Exception e1)
            {
                using (clsError clse = new clsError())
                {
                    ...
                    clse.FunctionName = "LeadDocumentCollectionSave";
                    clse.Link = "Lead/LeadDocumentCollection";
                    clse.PageName = "Lead Document Collection Controller";
            ...
            else
            {
                ...
                if (M.LeadId > 0)
                {
                    ...
                    dtLeadDoc2 = DataInterface1.dbLeadDocumentCollection(M);
                }
